...
- **Identity and appearance**: species, gender presentation, age range, skin tone. Hair: style, length, color, texture, parting, hairline shape, stray hairs, tied/loose state. Face: face shape, brow shape, eyebrow thickness and angle, eye shape and size, eyelid openness, eye spacing, iris color if visible, nose bridge and tip shape, nostril visibility, cheek fullness, lip shape and fullness, chin and jawline. Distinctive features: freckles, moles, scars, tattoos, piercings, facial hair, glasses, dental visibility, asymmetries.
